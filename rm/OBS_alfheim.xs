...
void main(void)
{
   ...
   // Straggler trees.
   PlaceDefNearPlayers(stragglerTreeID, false, rmRandInt(2, 5));
   ...
   if(rmRandFloat(0,1)<0.9)
      PlaceDefNearPlayers(closeElkID, false);
   else
      PlaceDefNearPlayers(closeElkID, false, rmRandInt(3,6));
 ...
 // Ruins
   ...
   // Herds.
   PlaceDefNearPlayers(mediumCowID, false); 
   ...
   // Gold.
   PlaceDefNearPlayers(farGoldID, false, rmRandInt(3, 4));

   // Bonus huntable.
   PlaceDefNearPlayers(bonusHuntableID, false, rmRandInt(1, 2));
...
/*      rmAddAreaConstraint(forestID, avoidImpassableLand); */
   ...
   // Random trees
   rmPlaceObjectDefAtLoc(randomTreeID, 0, 0.5, 0.5, 25*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(logID, 0, 0.5, 0.5, 3*cNonGaiaPlayers);
