...
/*      rmAddAreaConstraint(southOceanID, southOceanConstraint); */
   ...
   // Elev.
   int numTries=40*cNonGaiaPlayers;
   failCount=0;
   for(i=0; <numTries)
   {
   ...
   // Straggler trees.
   PlaceDefNearPlayers(stragglerTreeID, false, rmRandInt(5, 8));
   ...
   // Gold
   PlaceDefNearPlayers(startingGoldID, false, 2);
   ...
   // goats
   PlaceDefNearPlayers(mediumGoatsID, false, rmRandInt(1, 2));
   
   // Far things.
   
   // Gold.
   rmPlaceObjectDefInArea(farGoldID, 0, goldArea, cNonGaiaPlayers*rmRandInt(2, 3));
   ...
   // goats
   PlaceDefNearPlayers(farGoatsID, false, rmRandInt(1, 2));
   ...
   rmPlaceObjectDefInArea(fishID, 0, rmAreaID("north ocean"), 3*cNonGaiaPlayers);
   rmPlaceObjectDefInArea(fishID, 0, rmAreaID("south ocean"), 3*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(rockID2, 0, 0.5, 0.5, 6*cNonGaiaPlayers); 
