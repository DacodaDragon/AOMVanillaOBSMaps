...
/*      rmAddAreaConstraint(lavaPatch, patchConstraint); */
 ...
 /*        rmSetAreaLocation(elevID, rmRandFloat(0.0, 1.0), rmRandFloat(0.0, 1.0)); */
   ...
   PlaceDefNearPlayers(mediumBoarID, false, rmRandInt(1, 2));
   ...
   // Random trees.
   rmPlaceObjectDefAtLoc(randomTreeID, 0, 0.5, 0.5, 40*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(stalagmiteID, 0, 0.5, 0.5, 7*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(stalagmite2ID, 0, 0.5, 0.5, 10*cNonGaiaPlayers);
  ...
  // Text
   ...
   rmPlaceObjectDefAtLoc(stalagmite3ID, 0, 0.5, 0.5, 5*cNonGaiaPlayers);
   ...
   if(styx==0)
      rmPlaceObjectDefAtLoc(flameID, 0, 0.5, 0.5, 8*cNonGaiaPlayers);
   ...
   if(styx==0)
      rmPlaceObjectDefAtLoc(bubbleID, 0, 0.5, 0.5, 3*cNonGaiaPlayers);
   ...
   PlaceDefNearPlayers(farHarpyID, false, 2); 
