...
void main(void)
{
   ...
   // Gold
   PlaceDefNearPlayers(startingGoldID, false, rmRandInt(1, 2));
   ...
   // Boar.
   PlaceDefNearPlayers(closeBoarID, false, rmRandInt(1, 2));
   ...
   int forestCount=6*cNonGaiaPlayers;
   failCount=0;
   for(i=0; <forestCount)
   {
   ...
   rmPlaceObjectDefAtLoc(runeID, 0, 0.5, 0.5, 2*cNonGaiaPlayers); 
