...
// Main entry point for random map script
  ...
  // Set up player areas.
   ...
   if(terrainChance == 1)
   {
      ...
      rmPlaceObjectDefAtLoc(fishID, 0, 0.5, 0.5, 2*cNonGaiaPlayers);
      ...
      rmPlaceObjectDefAtLoc(sharkID, 0, 0.5, 0.5, 0.5*cNonGaiaPlayers);
   }
   ...
   // Pigs
   PlaceDefNearPlayers(mediumPigsID, false, 2);
