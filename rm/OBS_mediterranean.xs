...
/*   if(cNonGaiaPlayers < 4)
   ...
   rmPlaceObjectDefAtLoc(fishID, 0, 0.5, 0.5, 3*cNonGaiaPlayers);
   ...
   rmAddObjectDefConstraint(fishID, fishVsFishID);
   rmAddObjectDefConstraint(fishID, fishLand);
   rmPlaceObjectDefAtLoc(fishID, 0, 0.5, 0.5, 1*cNonGaiaPlayers);
  ...
  // Text
   ...
   rmPlaceObjectDefAtLoc(sharkID, 0, 0.5, 0.5, cNonGaiaPlayers*0.5); 
...
/*      rmSetAreaTerrainType(elevID, "SnowA"); */
  ...
  // Text
   ...
   // Settlements.
   //PlaceDefNearPlayers(farSettlementID, true, 2);
   ...
   // Goats
   PlaceDefNearPlayers(closePigsID, true);
   ...
   // Medium things....
   // Gold
   PlaceDefNearPlayers(mediumGoldID, false);
   ...
   // Gold.
   PlaceDefNearPlayers(farGoldID, false, 3);
   ...
   // Berries.
   rmPlaceObjectDefAtLoc(farBerriesID, 0, 0.5, 0.5, cPlayers);

   // Predators
   PlaceDefNearPlayers(farPredatorID, false, 1);

   // Random trees.
   rmPlaceObjectDefAtLoc(randomTreeID, 0, 0.5, 0.5, 10*cNonGaiaPlayers);
   ...
   int forestCount=10*cNonGaiaPlayers;
   failCount=0;
   for(i=0; <forestCount)
   {
  ...
  // Text
   ...
   rmPlaceObjectDefAtLoc(rockID2, 0, 0.5, 0.5, 8*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(kelpID, 0, 0.5, 0.5, 2*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(kelp2ID, 0, 0.5, 0.5, 6*cNonGaiaPlayers);
