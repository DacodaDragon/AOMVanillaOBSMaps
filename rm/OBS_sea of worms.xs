...
// Main entry point for random map script
  ...
  for(i=1; <numIsland)
  {
      ...
      rmSetAreaSize(bonusID, rmAreaTilesToFraction(1000), rmAreaTilesToFraction(2000));
...
/*   PlaceDefNearPlayers(startingGoldID, false); */
   ...
   PlaceDefNearPlayers(closeBerriesID, false);
   ...
   // Gold.
   PlaceDefNearPlayers(farGoldID, false, rmRandInt(1,2));
