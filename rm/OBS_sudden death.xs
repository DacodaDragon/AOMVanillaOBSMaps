...
/*      rmAddAreaConstraint(id, playerConstraint); */
   ...
   // Straggler trees.
   PlaceDefNearPlayers(stragglerTreeID, false, 10);

   // Gold
   PlaceDefNearPlayers(startingGoldID, false, 3);
   ...
   PlaceDefNearPlayers(farGoldID, false, rmRandInt(2, 3));

   // Goats
   PlaceDefNearPlayers(closeGoatsID, false, 2);
   ...
   PlaceDefNearPlayers(bonusHuntableID, false, 2);
   ...
   int forestCount=5*cNonGaiaPlayers;
   failCount=0;
   for(i=0; <forestCount)
   {
   ...
   rmPlaceObjectDefAtLoc(bushID2, 0, 0.5, 0.5, 8*cNonGaiaPlayers); 
   initObs();
   // Text
