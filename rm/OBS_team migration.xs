...
/*   rmBuildArea(bonusID); */
   ...
   // Build team areas
   float percentPerPlayer = 0.2/cNonGaiaPlayers;
   float teamSize = 0; 
 ...
 /*  if(cTeams > 2)
   ...
   rmPlaceObjectDefInArea(farSettlementID, 0, bonusID, cNonGaiaPlayers);
   ...
   // player fish
   PlaceDefNearPlayers(playerFishID, false, 6);
...
/*   PlaceDefNearPlayers(mediumGoldID, false); */
   ...
   // Gold
   rmPlaceObjectDefInArea(farGoldID, 0, bonusID, rmRandInt(2,3)*cNonGaiaPlayers);

  // Hawks
   PlaceDefNearPlayers(farhawkID, false, 2); 

   // Relics
   rmPlaceObjectDefInArea(relicID, 0, bonusID, cNonGaiaPlayers);

   // Pigs
   rmPlaceObjectDefInArea(farPigsID, 0, bonusID, 2*cNonGaiaPlayers);

   // Bonus huntable.
   rmPlaceObjectDefInArea(bonusHuntableID, 0, bonusID, cNonGaiaPlayers);

   // Predators
   rmPlaceObjectDefInArea(farPredatorID, 0, bonusID, cNonGaiaPlayers);

   // Random trees.
   rmPlaceObjectDefAtLoc(randomTreeID, 0, 0.5, 0.5, 10*cNonGaiaPlayers);

/*   // Crocs.
   rmPlaceObjectDefInRandomAreaOfClass(farCrocsID, false, classBonusIsland, cNonGaiaPlayers); */
   ...
   rmPlaceObjectDefAtLoc(fishID, 0, 0.5, 0.5, 15*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(sharkID, 0, 0.5, 0.5, 2*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(grassID, 0, 0.5, 0.5, 18*cNonGaiaPlayers);
