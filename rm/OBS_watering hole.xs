...
/* Gazelle were placed as player's */
  ...
  // Create team connections
   ...
   PlaceDefNearPlayers(startingSettlementID, true);
    ...
    // Elev.
   int failCount=0;
   int numTries1=10*cNonGaiaPlayers;
 ...
 /*  {
   ...
   // Towers.
   PlaceDefNearPlayers(startingTowerID, true, 3);
   PlaceDefNearPlayers(startingTower2ID, true, 1);

   // Straggler trees.
   PlaceDefNearPlayers(stragglerTreeID, false, rmRandInt(0, 7));
   ...
   // Gazelle
   PlaceDefNearPlayers(closeGazelleID, false); 
  ...
  // Bonus Gold
   PlaceDefNearPlayers(bonusGoldID, false, rmRandInt(1,2));
   ...
   // Random trees.
   rmPlaceObjectDefAtLoc(randomTreeID, 0, 0.5, 0.5, 5*cNonGaiaPlayers);

   rmPlaceObjectDefAtLoc(randomTreeID2, 0, 0.5, 0.5, 2*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(rockID, 0, 0.5, 0.5, 5*cNonGaiaPlayers);
   ...
   rmPlaceObjectDefAtLoc(rockID2, 0, 0.5, 0.5, 4*cNonGaiaPlayers); 
   ...
   rmPlaceObjectDefAtLoc(lilyID, 0, 0.5, 0.5, 5*cNonGaiaPlayers); 
   ...
   rmPlaceObjectDefAtLoc(lily2ID, 0, 0.5, 0.5, 5*cNonGaiaPlayers); 
   ...
   rmPlaceObjectDefAtLoc(decorID, 0, 0.5, 0.5, 10*cNonGaiaPlayers);
